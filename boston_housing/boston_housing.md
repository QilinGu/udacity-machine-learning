...
**Answer:**
I would consider that the model has successfully captured the variation of the target variable since the R^2 is high as 0.923. It has 92.5% chance of capturing the percentage of squared correlation between the predicted and actual values of the target variable.
...
**Answer: **
Without splitting dataset into train and test parts, the result cannot be evaluated. If the model is evaluated with the same dataset used for the training, it will have more chance of getting high score when it really is not.
It is like having a exam that has exactly same questions, word by word, for what you've studied. 
In order to reasonably tell the performance of the model, the model should be tested on the new dataset it has never seen before.
